...
export default function FAQSection() {
  const faqs = [
    {
      q: "كيف يمكنني حجز موعد في مركز القمة الطبي؟",
    ...
    },
    {
      ...
      a: "نعم، يقدم مركز القمة الطبي خيارات دفع مرنة وتسهيلات مخصصة لعمليات التجميل، زراعة الأسنان، وجراحات السمنة بالتنسيق مع الشركات والشركاء المعتمدين.",
    },
    {
    ...
    {
      q: "أين يقع موقع مركز القمة الطبي في عمان؟",
