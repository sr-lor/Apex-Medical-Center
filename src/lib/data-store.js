...
export const initialDoctors = [
  {
    ...
    nameAr: "د. علاء",
    nameEn: "Dr. Alaa",
    titleAr: "استشاري الجراحة التجميلية وتنسيق القوام",
    ...
    experienceAr: "استشاري كفؤ ومتميز في عمليات تجميل الوجه وتنسيق القوام والشفط بالفيزر.",
    experienceEn: "Consultant Plastic Surgeon specialized in facial aesthetics and body contouring.",
