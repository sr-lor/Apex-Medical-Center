...
export const initialDoctors = [
  {
    ...
    branchIds: ["azaiba"],
    nameAr: "د. بلال حاج حامد",
    nameEn: "Dr. Belal Haj-Hamed",
    titleAr: "طبيب أسنان عام وتجميلي (BDS, INBDE, Brazil Fellowship)",
    titleEn: "General & Cosmetic Dentist (BDS, INBDE, Brazil Fellowship)",
    ...
    experienceAr: "خبرة أكثر من 6 سنوات في طب الأسنان العام والتجميلي. حاصل على بكالوريوس جراحة الأسنان (BDS)، ومعتمد من المجلس الأمريكي لطب الأسنان (INBDE)، وأكمل زمالة تجميل الأسنان في ساو باولو، البرازيل. عضو في الجمعية الأمريكية لطب الأسنان (ADA).",
    experienceEn: "Over 6 years of experience in general and cosmetic dentistry. Holds a BDS, American Board INBDE certification, and a fellowship in São Paulo, Brazil. Member of the American Dental Association (ADA).",
  },
  {
    id: "dr-hosam",
    branchIds: ["azaiba"],
    nameAr: "د. حسام الدين هابيل",
    nameEn: "Dr. Hosam Al-Din Habel",
    titleAr: "أخصائي الطب الباطني (البورد السوري)",
    titleEn: "Internal Medicine Specialist (Syrian Board)",
    ...
    experienceAr: "خبرة سريرية 15 عاماً في الطب الباطني (10 سنوات في المستشفيات الجامعية السورية و5 سنوات في عمان). متخصص في إدارة السكري، ضغط الدم، الربو، وأمراض المفاصل والروماتيزم، مع خبرة 5 سنوات في العناية المركزة. حاصل على البورد السوري.",
    experienceEn: "15 years of clinical experience in internal medicine (10 years in Syrian university hospitals and 5 years in Oman). Expert in diabetes, hypertension, asthma, joint diseases, and ICU care. Syrian Board certified.",
  },
  {
    id: "dr-bharti-khanna",
    branchIds: ["azaiba"],
    nameAr: "د. بهارتي خانا",
    nameEn: "Dr. Bharti Khanna",
    titleAr: "أخصائية تقويم الأسنان والوجه والفكين (الميدالية الذهبية)",
    titleEn: "Specialist Orthodontist (Gold Medalist)",
    ...
    experienceAr: "خبرة أكثر من 13 سنة كأخصائية تقويم الأسنان. حاصلة على درجة الماجستير والميدالية الذهبية في تقويم الأسنان والوجه والفكين من الهند، وممارسة معتمدة لتقويم إنفيزالاين الشفاف (Invisalign) منذ عام 2017.",
    experienceEn: "13+ years of experience as an orthodontist. Holds a Master's degree (Gold Medalist) in Orthodontics & Dentofacial Orthopedics from India. Certified Invisalign practitioner since 2017.",
  },
  {
    id: "dr-marwa-jbara",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائية الأمراض الجلدية والطب التجميلي",
    titleEn: "Specialist Dermatologist & Aesthetic Medicine Practitioner",
    ...
    experienceAr: "خبرة سريرية أكثر من 10 سنوات في الأمراض الجلدية والطب التجميلي (حقن الفيلر، البوتوكس، خيوط شد الوجه، تجديد نضارة البشرة، وتحفيز الكولاجين، وعلاج تساقط الشعر). حاصلة على MD من جامعة دمشق والبورد السوري في الجلدية.",
    experienceEn: "Over 10 years of clinical experience in dermatology and aesthetic medicine (Botox, fillers, thread lifting, skin rejuvenation, collagen biostimulators, and hair loss treatments). MD & Syrian Board certified.",
  },
  {
    id: "dr-anil-dalal",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائي علاج عصب وجذور الأسنان (ماجستير)",
    titleEn: "Specialist Endodontist (MSc)",
    ...
    experienceAr: "خبرة 13 عاماً في المستشفيات المرموقة بسلطنة عمان. حاصل على درجة الماجستير في علاج الجذور وطب الأسنان الترميمي. متميز في علاج عصب الأسنان المعقدة بدون ألم والتركيبات والجسور. عضو الجمعية الهندية لعلاج الجذور.",
    experienceEn: "13 years of experience in reputed hospitals in Oman. Master's in Endodontics & Restorative Dentistry. Skilled in painless single-session root canal treatments for complex cases. Member of Indian Endodontic Society.",
  },
  {
    id: "dr-zainab-al-mamari",
    branchIds: ["azaiba"],
    nameAr: "د. زينب المعمرية",
    nameEn: "Dr. Zainab Al Mamari",
    titleAr: "طبيبة أسنان عامة وأطفال (BDS)",
    titleEn: "General & Pediatric Dentist (BDS)",
    specialtyId: "cosmetic-dentistry-3",
    specialtyAr: "طب الأسنان العام والأطفال",
    specialtyEn: "General Dentistry",
    image: "/wp-content/uploads/2026/07/NO-IMAGE.jpg",
    experienceAr: "طبيبة أسنان عامة تمتلك 6 سنوات من الخبرة في تقديم العلاجات السنية الشاملة وطب أسنان الأطفال، مع تركيز قوي على راحة المريض والعناية الوقائية. حاصلة على بكالوريوس جراحة الأسنان (BDS).",
    experienceEn: "General dentist with 6 years of experience in comprehensive dental care and pediatric dentistry, focusing on patient comfort and preventive care. Holds a BDS degree.",
  },
  {
    id: "dr-thura-hatem",
    branchIds: ["azaiba"],
    nameAr: "د. ثريا حاتم محمود القويضي",
    nameEn: "Dr. Thura Hatem Mahmood Alquaizi",
    titleAr: "أخصائية تجميل وترميم الأسنان وعلاج الجذور (ماجستير إيطاليا)",
    titleEn: "Specialist Esthetic & Conservative Dentistry (MSc Italy)",
    specialtyId: "cosmetic-dentistry-3",
    ...
    experienceAr: "خبرة سريرية 17 عاماً. حاصلة على ماجستير تجميل وترميم الأسنان من جامعة سابينزا روما إيطاليا ودبلوم علاج العصب من الأكاديمية البريطانية. متخصصة في الفينير التجميلي، تصميم الابتسامة، وعلاج القنوات اللبية والتركيبات الثابتة.",
    experienceEn: "17 years of clinical experience. Holds an MSc in Esthetic & Conservative Dentistry from Sapienza University of Rome, Italy, and a Diploma in Endodontics from the British Academy. Specialist in veneers and digital smile design.",
  },
  {
    id: "alaa-laser-tech",
    branchIds: ["azaiba"],
    nameAr: "آلاء",
    nameEn: "Alaa",
    titleAr: "أخصائية وفنية الليزر والعناية بالبشرة (مرخصة وزارة الصحة)",
    titleEn: "Licensed Laser & Skincare Specialist (MOH Oman)",
    specialtyId: "skin-care-laser-treatments",
    specialtyAr: "العناية بالبشرة والليزر",
    specialtyEn: "Laser & Skincare",
    image: "/wp-content/uploads/2026/07/Alaa-apexmedicaloman.jpg",
    experienceAr: "خبرة 8 سنوات | حاصلة على دبلوم التمريض من أكاديمية أوكسفورد، وشهادة تقنية من أكاديمية فاي (Phi Academy) النمسا، وترخيص فني ليزر من وزارة الصحة العمانية. متخصصة في أحدث أجهزة الليزر الطبية والعناية الشاملة بالبشرة.",
    experienceEn: "8 years of experience. Diploma of Nursing (Oxford), Technical Certificate from Phi Academy (Austria), and MOH Oman Licensed Laser Technician. Expert in non-surgical laser treatments and skincare.",
  },
  {
    ...
    nameAr: "علياء الدار",
    nameEn: "Aliaa Aldara",
    titleAr: "أخصائية وفنية الفيشل والعناية بالبشرة والوجه",
    titleEn: "Facial Technician & Skincare Specialist",
    specialtyId: "skin-care-laser-treatments",
    ...
    experienceAr: "أخصائية وفنية متخصصة في جلسات الفيشل العلاجي والتجميلي، وتنظيف البشرة العميق، وتقنيات نضارة الوجه المتقدمة بمركز القمة الطبي.",
    experienceEn: "Specialized Facial & Skincare Technician at Apex Medical Center. Expert in therapeutic facials, deep skin cleansing, and facial rejuvenation.",
  },
  {
    id: "arij-laser-tech",
    branchIds: ["azaiba"],
    nameAr: "أريج",
    nameEn: "Arij",
    titleAr: "أخصائية وفنية الليزر والعناية بالبشرة",
    ...
    experienceAr: "فنية وأخصائية ليزر إزالة الشعر والعناية بالبشرة بمركز القمة الطبي، تتميز بالدقة والخبرة في تقديم أفضل نتائج إزالة الشعر بالليزر والعناية المتقدمة بالبشرة.",
    experienceEn: "Licensed Laser Technician at Apex Medical Center specializing in medical laser hair removal and advanced skin care treatments.",
  },
];
