...
export const initialDoctors = [
  {
    ...
    titleAr: "استشاري جراحة العظام والمفاصل والمناظير",
    titleEn: "Consultant Orthopedic Surgeon",
    specialtyId: "orthopedic-surgery",
    specialtyAr: "جراحة العظام والمفاصل",
    specialtyEn: "Orthopedic Surgery",
    image: "/wp-content/uploads/2026/07/Belal-Haj-Hamed-apexmedicaloman.jpg",
    experienceAr: "خبرة واسعة في جراحة العظام وتبديل المفاصل ومناظير الركبة والكتف.",
    experienceEn: "Consultant in joint replacement and arthroscopic surgeries.",
    availableDaysAr: "السبت - الأربعاء (10:00 ص - 07:00 م)",
    availableDaysEn: "Sat - Wed (10:00 AM - 07:00 PM)",
  },
  {
    id: "dr-hosam",
    branchIds: ["azaiba"],
    ...
    titleAr: "استشاري زراعة وتجميل الأسنان",
    titleEn: "Consultant Cosmetic Dentist & Implantologist",
    specialtyId: "cosmetic-dentistry",
    ...
    experienceAr: "استشاري زراعة الأسنان وتصميم ابتسامة هوليود الرقمية.",
    experienceEn: "Expert in dental implants and Digital Smile Design.",
    availableDaysAr: "الأحد - الخميس (09:00 ص - 08:00 م)",
    availableDaysEn: "Sun - Thu (09:00 AM - 08:00 PM)",
  },
  {
    id: "dr-bharti-khanna",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائية الجلدية والتجميل",
    titleEn: "Specialist Dermatologist",
    ...
    experienceAr: "أخصائية لعلاج الأمراض الجلدية وتصبغات البشرة وحب الشباب.",
    experienceEn: "Specialist in clinical dermatology, acne, and skin peels.",
    availableDaysAr: "السبت - الأربعاء (10:00 ص - 06:00 م)",
    availableDaysEn: "Sat - Wed (10:00 AM - 06:00 PM)",
  },
  {
    id: "dr-marwa-jbara",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائية الجلدية والتجميل والليزر",
    titleEn: "Dermatologist & Laser Specialist",
    specialtyId: "dermatology-cosmetology",
    specialtyAr: "الجلدية والتجميل",
    specialtyEn: "Dermatology & Cosmetology",
    image: "/wp-content/uploads/2026/07/Marwa-jbara-apexmedicaloman.jpg",
    experienceAr: "خبيرة في حقن الفيلر والبوتوكس وجلسات تجديد نضارة الوجه والبشرة.",
    experienceEn: "Expert in Botox, fillers, and facial skin rejuvenation.",
    availableDaysAr: "السبت - الخميس (10:00 ص - 08:00 م)",
    availableDaysEn: "Sat - Thu (10:00 AM - 08:00 PM)",
  },
  {
    id: "dr-anil-dalal",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائي علاج عصب وجذور الأسنان",
    ...
    experienceAr: "أخصائي متميز في علاج عصب الأسنان المعقدة وحشو الجذور بدون ألم.",
    experienceEn: "Specialist in endodontics and single-session root canal treatment.",
    availableDaysAr: "يومياً عدا الجمعة (09:00 ص - 09:00 م)",
    availableDaysEn: "Daily except Friday (09:00 AM - 09:00 PM)",
  },
  {
    ...
    titleAr: "أخصائية طب وتجميل الأسنان",
    titleEn: "Specialist Cosmetic Dentist",
    specialtyId: "cosmetic-dentistry",
    specialtyAr: "طب وتجميل الأسنان",
    specialtyEn: "Cosmetic Dentistry",
    image: "/wp-content/uploads/2026/07/NO-IMAGE.jpg",
    experienceAr: "أخصائية متميزة في علاج وتجميل الأسنان والتركيبات التجميلية والعناية الفموية.",
    experienceEn: "Specialist in cosmetic dentistry, dental restorations, and oral health.",
    availableDaysAr: "السبت - الخميس (09:00 ص - 09:00 م)",
    availableDaysEn: "Sat - Thu (09:00 AM - 09:00 PM)",
  },
  {
    id: "dr-thura-hatem",
    branchIds: ["azaiba"],
    ...
    titleAr: "أخصائية الطب والتجميل النسائي",
    titleEn: "Specialist Aesthetic Gynecologist",
    specialtyId: "aesthetic-gynecology",
    specialtyAr: "الطب والتجميل النسائي",
    specialtyEn: "Aesthetic Gynecology",
    image: "/wp-content/uploads/2026/07/Thura-Hatem-Mahmood-Alquaizi-apexmedicaloman.jpg",
    experienceAr: "أخصائية التجميل النسائي والعلاج بالليزر والبلازما برعاية تامة.",
    experienceEn: "Specialist in female aesthetic laser and PRP procedures.",
    availableDaysAr: "الأحد - الخميس (10:00 ص - 06:00 م)",
    availableDaysEn: "Sun - Thu (10:00 AM - 06:00 PM)",
  },
  {
    id: "alaa-laser-tech",
    branchIds: ["azaiba"],
    nameAr: "آلاء",
    nameEn: "Alaa",
    titleAr: "أخصائية وفنية الليزر والعناية بالبشرة (Laser Tech)",
    titleEn: "Laser Technician",
    specialtyId: "skin-care-laser-treatments",
    specialtyAr: "العناية بالبشرة والليزر",
    specialtyEn: "Laser & Skin Care",
    image: "/wp-content/uploads/2026/07/Alaa-apexmedicaloman.jpg",
    experienceAr: "أخصائية وفنية خبيرة في جلسات إزالة الشعر بالليزر وتجديد نضارة البشرة.",
    experienceEn: "Expert laser technician for laser hair removal and skin treatments.",
    availableDaysAr: "السبت - الخميس (09:00 ص - 08:00 م)",
    availableDaysEn: "Sat - Thu (09:00 AM - 08:00 PM)",
  },
  {
    id: "aliaa-aldara-facial-tech",
    branchIds: ["azaiba"],
    nameAr: "علياء الدار",
    nameEn: "Aliaa Al Dara",
    titleAr: "أخصائية وفنية الفيشل والعناية بالبشرة (Facial Tech)",
    titleEn: "Facial Technician & Skin Care Specialist",
    specialtyId: "skin-care-laser-treatments",
    specialtyAr: "العناية بالبشرة والوجه",
    specialtyEn: "Facial & Skin Care",
    image: "/wp-content/uploads/2026/07/Aliaa-Aldara-apexmedicaloman.jpg",
    experienceAr: "أخصائية وفنية خبيرة في جلسات الفيشل وتنظيف البشرة العميق والعناية بالوجه.",
    experienceEn: "Specialist facial technician for deep cleansing and skin rejuvenation.",
    availableDaysAr: "الأحد - الخميس (09:30 ص - 07:30 م)",
    availableDaysEn: "Sun - Thu (09:30 AM - 07:30 PM)",
  },
  {
    id: "arij-laser-tech",
    branchIds: ["azaiba"],
    ...
    experienceAr: "أخصائية وفنية متميزة في جلسات إزالة الشعر بالليزر والعناية بالبشرة وتقنيات النضارة.",
    experienceEn: "Specialist laser technician for laser hair removal and skin treatments.",
    availableDaysAr: "السبت - الخميس (09:00 ص - 08:00 م)",
    availableDaysEn: "Sat - Thu (09:00 AM - 08:00 PM)",
  },
];
