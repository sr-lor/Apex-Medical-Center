...
export const initialDoctors = [
  {
    id: "alaa-laser-specialist",
    branchIds: ["azaiba"],
    nameAr: "آلاء",
    nameEn: "Alaa",
    titleAr: "أخصائية ليزر وإزالة الشعر",
    titleEn: "Laser & Hair Removal Specialist",
    specialtyId: "skin-care-laser-treatments",
    specialtyAr: "العناية بالبشرة والليزر",
    specialtyEn: "Laser & Hair Removal",
    image: "/wp-content/uploads/2026/07/Alaa-apexmedicaloman.jpg",
    experienceAr: "أخصائية خبيرة ومتميزة في أحدث تقنيات وجلسات إزالة الشعر بالليزر والعناية بالبشرة.",
    experienceEn: "Expert specialist in advanced laser hair removal and skin rejuvenation.",
  ...
  },
  {
    id: "dr-thura-hatem",
    branchIds: ["azaiba"],
    nameAr: "د. ثريا حاتم القويضي",
    nameEn: "Dr. Thura Hatem Alquaizi",
  ...
  },
  {
    id: "dr-aliaa-aldara",
    branchIds: ["azaiba"],
    nameAr: "د. علياء الدار",
    nameEn: "Dr. Aliaa Al Dara",
    titleAr: "أخصائية تجميل الأسنان والتقويم",
    titleEn: "Cosmetic Dentist & Orthodontist",
    specialtyId: "cosmetic-dentistry",
    specialtyAr: "طب وتجميل الأسنان",
    specialtyEn: "Cosmetic Dentistry",
    image: "/wp-content/uploads/2026/07/Aliaa-Aldara-apexmedicaloman.jpg",
    experienceAr: "أخصائية تجميل الأسنان والتقويم الشفاف وابتسامة المشاهير.",
    experienceEn: "Specialist in clear aligners and cosmetic teeth restorations.",
