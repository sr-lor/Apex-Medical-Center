...
export const initialDoctors = [
  {
    ...
    titleAr: "طبيب أسنان عام وتجميلي (BDS, INBDE, Brazil)",
    titleEn: "General & Cosmetic Dentist",
    specialtyId: "cosmetic-dentistry-3",
    specialtyAr: "طب الأسنان العام والتجميلي",
  ...
  },
  {
    ...
    titleAr: "أخصائي الأمراض الباطنية (البورد السوري)",
  ...
  },
  {
    ...
    specialtyAr: "تقويم الأسنان والوجه والفكين",
    specialtyEn: "Orthodontics & Dentofacial Orthopedics",
  ...
  },
  {
    ...
    specialtyAr: "الأمراض الجلدية والطب التجميلي",
    specialtyEn: "Dermatology & Aesthetic Medicine",
  ...
  },
  {
    ...
    titleAr: "أخصائي علاج عصب وجذور الأسنان وطب الأسنان الترميمي",
    titleEn: "Specialist Endodontist & Restorative Dentistry",
    specialtyId: "endodontics",
    specialtyAr: "علاج عصب وجذور الأسنان",
  ...
  },
  {
    ...
    titleAr: "طبيبة أسنان عامة (BDS)",
    titleEn: "General Dentist (BDS)",
    specialtyId: "cosmetic-dentistry-3",
    specialtyAr: "طب الأسنان العام وطب أطفال",
  ...
  },
  {
    ...
    titleAr: "طبيبة أسنان - أخصائية تجميل وترميم الأسنان (MSc إيطاليا)",
    titleEn: "Dentist – Specialist Esthetic & Conservative Dentistry MSc",
    specialtyId: "cosmetic-dentistry-3",
    specialtyAr: "تجميل وترميم الأسنان وعلاج الجذور",
    specialtyEn: "Esthetic & Conservative Dentistry",
  ...
  },
  {
    ...
    nameAr: "آلاء",
    nameEn: "Alaa",
    titleAr: "فنية وأخصائية ليزر مرخصة (Laser Technician)",
    titleEn: "Licensed Laser Technician (MOH Oman)",
  ...
  },
  {
    ...
    nameAr: "علياء الدار",
    nameEn: "Aliaa Aldara",
    titleAr: "فنية وأخصائية الفيشل (Facial Technician)",
  ...
  },
  {
    ...
    nameAr: "أريج",
    nameEn: "Arij",
    titleAr: "فنية وأخصائية ليزر (Laser Technician)",
